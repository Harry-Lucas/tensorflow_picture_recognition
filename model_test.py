...
MODEL_SAVE_PATH = 'D:/work_coding/coding/git/tensorflow_train/models/'
TEST_IMAGE_PATH = 'D:/work_coding/coding/git/tensorflow_train/test/'
...
def model_test():
    ...
    # 加载graph
    saver = tf.train.import_meta_graph(MODEL_SAVE_PATH + "crack_captcha.model-100.meta")
